                                ...
                                <form class="form-horizontal" method="post" action="calendar_upload.php" id="myform"
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="month-list" id="month-list">
                                            <div class="form-group row" id="month1">
                                                <label class="col-sm-3  col-form-label" for="month">Month 1
                                                </label>
                                                <div class="col-sm-3">
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <input type="text" name="month_days[]" class="form-control"
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            ...
                                            <button type="submit" name="myButton" id="myButton"
                                                ...
                                                onClick="window.location.href='serviceCatView.php'; return false;">Cancel</button>
                                        </div>
                                    </div>
