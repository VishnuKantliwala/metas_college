                        ...
                        <div class="col-12">
                            <div class="card-box">
                                ...
                                <form class="form-horizontal" method="post" action="team_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    $records=$con->selectdb("SELECT * FROM tbl_team_category  where cat_id=".$category_id."");
                                    ...
                                    ?>
										...
										<div class="form-group">
											...
											<div class="col-sm-12">
                                                ...
                                                <?php if($row[4]!=''){?>
												    <a class="btn btn-lighten-danger" href="team_upload.php?id=<?php echo $row[0]; ?>&Image=Del" onClick="return confirm('Are you sure want to delete?');">Delete</a>
											    <?php }?>  
                                            </div>
                                        </div>
