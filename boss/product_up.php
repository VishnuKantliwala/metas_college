                                ...
                                <form class="form-horizontal" method="post" action="prod_upload.php" id="myform"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="slug" name="slug"
                                                placeholder="Slug" value="<?php echo $row[12]; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" style="display:none">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="date" name="date"
                                                placeholder="Date" value="<?php echo $row[13]; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" style="display:none">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="month" name="month"
                                                placeholder="Month" value="<?php echo $row[14]; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="product_name"
                                                name="product_name" value="<?php echo $row[1]; ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea class="ckeditor" cols="80" id="description" name="description"
                                                rows="10"><? echo $row[2];?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-12 control-label">Eligibility and
                                            Selection Process</label>
                                        <div class="col-sm-12">
                                            <textarea class="ckeditor" cols="80" id="course_e_and_s_process"
                                                name="course_e_and_s_process"
                                                rows="10"><? echo $row['course_e_and_s_process'];?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label">Admission
                                            process</label>
                                        <div class="col-sm-12">
                                            <textarea class="ckeditor" cols="80" id="course_admission_process"
                                                name="course_admission_process"
                                                rows="10"><? echo $row['course_admission_process'];?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label">Application
                                            process</label>
                                        <div class="col-sm-12">
                                            <textarea class="ckeditor" cols="80" id="course_application_process"
                                                name="course_application_process"
                                                rows="10"><? echo $row['course_application_process'];?></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="file" id="frontimg" name="frontimg"
                                                    data-default-file="<?if($row[4]!=''){echo '../product/'.$row[4];}?>"
                                                    class="dropify" />
                                                <? if($row[4]!=''){?>
                                                <!-- <img src="../product/<? echo $row[4];?>" width="100"> -->
                                                <a href="prod_upload.php?id=<?php echo $row[0]; ?>&ProImage=Del"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="hidden" class="form-control" id="frontpdf" name="frontpdf"
                                                placeholder="Multiple pdfs" value="<? echo $row['pdf_file']; ?>">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                                ...
                                                                <span class="tag label label-info bg-light">
                                                                    <div class=" custom-control custom-switch">
                                                                        <input class="custom-control-input"
                                                                            type="checkbox"
                                                                            id="<?php echo $pdf_list[$i]; ?>"
                                                                            name="pdfEdit[]"
                                                                            value="<?php echo $pdf_list[$i]; ?>">
                                                                        <label class="custom-control-label"
                                                                            for="<?php echo $pdf_list[$i]; ?>">
                                                                            <?echo $pdf_list[$i];?></label>
                                                                    </div>
                                                                </span>
                                                            </div>
                                                            <?php
                                    ...
                                    <div class="form-group" style="display:none">
                                        ...
                                        <input type="hidden" class="form-control" id="frontimg1" name="frontimg1"
                                            placeholder="Multiple Images" value="<? echo $row['multi_images']; ?>">
                                        <div class="col-sm-4">
                                                    ...
                                                    <li class="list-inline-item file-box">
                                                        <div class=" custom-control custom-switch">
                                                            <input class="custom-control-input" type="checkbox"
                                                                name="imageEdit[]" id="<?php echo $image_list[$i]; ?>"
                                                                value="<?php echo $image_list[$i]; ?>">
                                                            <label class="custom-control-label"
                                                                for="<?php echo $image_list[$i]; ?>">
                                                                <img src="../productF/<?php echo $image_list[$i]; ?>"
                                                                    class="img-fluid img-thumbnail" alt="attached-img"
                                                                    width="80">
                                                            </label>
                                                        </div>
                                                    </li>
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label">Faculty profile
                                            link</label>
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="course_faculty_profile_link"
                                                name="course_faculty_profile_link" placeholder="Faculty profile link"
                                                value="<?echo $row['course_faculty_profile_link']?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea cols="5" rows="5" class="form-control" id="meta_tag_description"
                                                ...
                                                placeholder="Meta Tag Description"><?php echo $row[9]?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea cols="5" rows="5" class="form-control" id="meta_tag_keywords"
                                                ...
                                                placeholder="Meta Tag Keywords"><?php echo $row[10]?></textarea>
                                        </div>
                                    </div>

                                    <div class="form-group" style="display:none">
                                        <label for="inputEmail3" class="col-sm-12 control-label">Course Video</label>
                                        <div class="col-sm-12">
                                            <textarea cols="5" rows="5" class="form-control" id="product_video"
                                                name="product_video"
                                                placeholder="Embeded code of the video"><?php echo $row[16]?></textarea>
                                        </div>
                                    </div>

                                    <div class="form-group" style="display:none">
                                        <label for="inputEmail3" class="col-sm-12 control-label">Course Map</label>
                                        <div class="col-sm-12">
                                            <textarea cols="5" rows="5" class="form-control" id="product_map"
                                                name="product_map"
                                                placeholder="Embeded code of the Map"><?php echo $row[17]?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            ...
                                            <button type="submit" name="myButton" id="myButton"
                                                class="btn btn-lighten-danger"
                                                onClick="window.location.href='productView.php'; return false;">Cancel</button>
                                        </div>
                                    </div>
