                            ...
                            <div class="card-box">
                                ...
                                <form class="form-horizontal" method="post" action="iqac_report_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="iqac_report_name" name="iqac_report_name" placeholder="IQAC Report Name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="file" id="iqac_report_file" name="iqac_report_file" accept="application/pdf" class="dropify"/>
                                        </div>
                                    </div>
