...
$con->connectdb();
	  ...
	  {	    
			...
			$recruiterImage = createImage('image_title',"../recruiter/");
        ...
        $con->insertdb("INSERT INTO `tbl_recruiter` (`image_title`, `desc_recruiter`, `recruiter_name`,`meta_tag_title`, `meta_tag_description`, `meta_tag_keywords`) VALUES ('".$recruiterImage."', '".$desc_recruiter."', '".$recruiter_name."', '".$meta_tag_title."', '".$meta_tag_description."', '".$meta_tag_keywords."');");
        
        // echo "INSERT INTO `tbl_recruiter` (`image_title`, `desc_recruiter`, `recruiter_name`,`meta_tag_title`, `meta_tag_description`, `meta_tag_keywords`) VALUES ('".$recruiterImage."', '".$desc_recruiter."', '".$recruiter_name."', '".$meta_tag_title."', '".$meta_tag_description."', '".$meta_tag_keywords."');";
                            ...
                            <div class="card-box">
								...
								<form class="form-horizontal" method="post" action="#" id="myform" name="myform" enctype="multipart/form-data">				
									...
									<div class="form-group">
										...
										<div class="col-sm-12">
											<input type="text" class="form-control" id="recruiter_name" name="recruiter_name" placeholder="Recruiter Name">
										</div>
									</div>										
									...
									<div class="form-group">
										...
										<div class="col-sm-12">
											<textarea type="text" class="ckeditor" id="desc_recruiter" name="desc_recruiter" placeholder="Description"></textarea>
										</div>
									</div>
