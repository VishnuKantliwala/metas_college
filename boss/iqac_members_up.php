...
$iqac_members_id=$_GET['iqac_members_id'];
?>
    ...
    <div id="wrapper">
        ...
        <div class="navbar-custom">
            ...
            <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                ...
                <li>
                    <h4 class="page-title-main">IQAC Members</h4>
                </li>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="mt-0 header-title">IQAC Members Form</h4>
                                <form class="form-horizontal" method="post" action="iqac_members_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    <input type="hidden" name="page" id="page" value="<? echo isset($_GET['page']);?>">
                                    
                                    <?php
                                    $records=$con->selectdb("SELECT * FROM tbl_iqac_members where iqac_members_id=".$iqac_members_id."");
                                    while($row=mysqli_fetch_array($records))
                                    {
                                    ?>
                                    <input type="hidden" name="iqac_members_id" id="iqac_members_id" value="<?php echo $row[0]; ?>" />	
                                    ...
                                    <div class="form-group" >
                                        <label for="inputEmail3" class="col-sm-12 control-label">IQAC Members Name</label>
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="iqac_members_name" name="iqac_members_name" value="<?php echo $row[1]; ?>" placeholder="IQAC Members Name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" style="display:none">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="file" id="frontimg" name="frontimg" class="dropify" data-default-file="<? if($row[4]!=''){echo "../iqac_members/".$row[4];}?>"/>
                                            <? if($row[4]!=''){?>
                                                <a href="iqac_members_upload.php?id=<?php echo $row[0]; ?>&ProImage=Del" class="btn btn-lighten-danger" onClick="return confirm('Are you sure want to delete?');">Delete</a>
                                            <? } ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input accept="application/pdf" type="file" id="iqac_members_file" name="iqac_members_file" class="dropify" data-default-file="<? if($row[6]!=''){echo "../iqac_members_pdf/".$row[6];}?>" />
                                            <? if($row[6]!=''){?>
                                                <a href="iqac_members_upload.php?id=<?php echo $row[0]; ?>&PDF=Del" class="btn btn-lighten-danger" onClick="return confirm('Are you sure want to delete?');">Delete</a>
                                            <? } ?>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-12">
                                            ...
                                            <button type="submit" name="myButton" id="myButton" class="btn btn-lighten-danger" onClick="window.location.href='iqac_membersView.php'; return false;" >Cancel</button>
                                        </div>
                                    </div>
