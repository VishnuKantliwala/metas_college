                            ...
                            <div class="card-box">
                                ...
                                <form class="form-horizontal" method="post" action="application_blog_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="application_blog_name" name="application_blog_name" placeholder="Blog Name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" style="display:none">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea class="form-control" id="application_blog_video" name="application_blog_video" rows="10" placeholder="Embeded link from youtube."></textarea>
                                        </div>
                                    </div>
