    ...
    $(document).ready(function(){ 
        ...
        $(function() {
            $(".sortable").sortable({ opacity: 0.6, cursor: 'move', update: function() {
                ...
                $.post("update_event_category.php", order, function(theResponse){
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="sortable">
                                <?php
								$query  = "SELECT * FROM tbl_eventcategory ORDER BY recordListingID ASC";
                                ...
                                <div id="recordsArray_<?php echo $row['cat_id'];?>" class="card card-draggable">
                                    <div class="card-body bg-light">
                                        <p class="card-text">
                                        <?php echo $row['recordListingID'].".".$row['cat_name']; ?>
                                        </p>
                                    </div>
                                </div>
								<?php } ?>
