...
$query = $cn->selectdb('SELECT * FROM tbl_calendar_category');
                            ...
                            <div class="card-box">
                                ...
                                <form class="form-horizontal" method="post" action="calendar_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="date" class="form-control" id="date" name="from_date" placeholder="Date">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="date" class="form-control" id="date" name="to_date" placeholder="Date">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="calendar_name" name="calendar_name" placeholder="Name">
                                        </div>
                                    </div>										
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <button type="submit" name="addCalendar" id="addCalendar" class="btn btn-success">Add</button>
