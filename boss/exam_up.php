    ...
    <div id="wrapper">
        ...
        <div class="navbar-custom">
            ...
            <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                ...
                <li>
                    <h4 class="page-title-main">Exam</h4>
                </li>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="mt-0 header-title">Exam Form</h4>
                                <form class="form-horizontal" method="post" action="exam_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    <input type="hidden" name="page" id="page" value="<? echo isset($_GET['page']);?>">
                                    
                                    <?php
                                    $records=$con->selectdb("SELECT * FROM tbl_exam where exam_id=".$exam_id."");
                                    while($row=mysqli_fetch_array($records))
                                    {
                                    ?>
                                    <input type="hidden" name="exam_id" id="exam_id" value="<?php echo $row[0]; ?>" />	
                                    ...
                                    <div class="form-group" >
                                        <label for="inputEmail3" class="col-sm-12 control-label">Exam Name</label>
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="exam_name" name="exam_name" value="<?php echo $row[1]; ?>" placeholder="Exam Name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" style="display:none">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="file" id="frontimg" name="frontimg" class="dropify" data-default-file="<? if($row[4]!=''){echo "../exam/".$row[4];}?>"/>
                                            <? if($row[4]!=''){?>
                                                <a href="exam_upload.php?id=<?php echo $row[0]; ?>&ProImage=Del" class="btn btn-lighten-danger" onClick="return confirm('Are you sure want to delete?');">Delete</a>
                                            <? } ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input accept="application/pdf" type="file" id="exam_file" name="exam_file" class="dropify" data-default-file="<? if($row[6]!=''){echo "../exam_pdf/".$row[6];}?>" />
                                            <? if($row[6]!=''){?>
                                                <a href="exam_upload.php?id=<?php echo $row[0]; ?>&PDF=Del" class="btn btn-lighten-danger" onClick="return confirm('Are you sure want to delete?');">Delete</a>
                                            <? } ?>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-12">
                                            ...
                                            <button type="submit" name="myButton" id="myButton" class="btn btn-lighten-danger" onClick="window.location.href='examView.php'; return false;" >Cancel</button>
                                        </div>
                                    </div>
