                            ...
                            <div class="card-box">
                                ...
                                <form class="form-horizontal" method="post" action="affiliations_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="affiliations_name" name="affiliations_name" placeholder="Affiliations Name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="file" id="affiliations_file" name="affiliations_file" accept="application/pdf" class="dropify"/>
                                        </div>
                                    </div>
