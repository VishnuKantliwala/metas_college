                        ...
                        <div class="col-12">
                            <div class="card-box">
                                ...
                                <form class="form-horizontal" method="post" action="prod_upload.php" id="myform"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="product_name"
                                                name="product_name" placeholder="Course Name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea class="ckeditor" cols="80" id="course_e_and_s_process"
                                                name="course_e_and_s_process" rows="10"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea class="ckeditor" cols="80" id="course_admission_process"
                                                name="course_admission_process" rows="10"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea class="ckeditor" cols="80" id="course_application_process"
                                                name="course_application_process" rows="10"></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-6">
                                            <label for="inputEmail3" class="col-sm-12 control-label">Syllabus PDF
                                                File</label>
                                            <div class="col-sm-12">
                                                <input type="file" id="download_file" name="download_file[]"
                                                    class="dropify" accept="application/pdf" multiple />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" style="display:none">
                                        <label for="inputEmail3" class="col-sm-2 control-label">Course Video</label>
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group" style="display:none">
                                        <label for="inputEmail3" class="col-sm-2 control-label">Course Map</label>
                                        <div class="col-sm-12">
