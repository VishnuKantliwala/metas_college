                            ...
                            <div class="card-box">
                                ...
                                <form class="form-horizontal" method="post" action="iqac_members_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="iqac_members_name" name="iqac_members_name" placeholder="IQAC Members Name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="file" id="iqac_members_file" name="iqac_members_file" accept="application/pdf" class="dropify"/>
                                        </div>
                                    </div>
