                            ...
                            <div class="card-box">
                                ...
                                <form class="form-horizontal" method="post" action="homepdf_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="homepdf_name" name="homepdf_name" placeholder="Home Pdf Name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="file" id="homepdf_file" name="homepdf_file" accept="application/pdf" class="dropify"/>
                                        </div>
                                    </div>
