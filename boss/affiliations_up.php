...
$affiliations_id=$_GET['affiliations_id'];
?>
    ...
    <div id="wrapper">
        ...
        <div class="navbar-custom">
            ...
            <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                ...
                <li>
                    <h4 class="page-title-main">Affiliations</h4>
                </li>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="mt-0 header-title">Affiliations Form</h4>
                                <form class="form-horizontal" method="post" action="affiliations_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    <input type="hidden" name="page" id="page" value="<? echo isset($_GET['page']);?>">
                                    
                                    <?php
                                    $records=$con->selectdb("SELECT * FROM tbl_affiliations where affiliations_id=".$affiliations_id."");
                                    while($row=mysqli_fetch_array($records))
                                    {
                                    ?>
                                    <input type="hidden" name="affiliations_id" id="affiliations_id" value="<?php echo $row[0]; ?>" />	
                                    ...
                                    <div class="form-group" >
                                        <label for="inputEmail3" class="col-sm-12 control-label">Affiliations Name</label>
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="affiliations_name" name="affiliations_name" value="<?php echo $row[1]; ?>" placeholder="Affiliations Name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="col-sm-4">
                                            <input type="file" id="frontimg" name="frontimg" class="dropify" data-default-file="<? if($row[4]!=''){echo "../affiliations/".$row[4];}?>"/>
                                            <? if($row[4]!=''){?>
                                                <a href="affiliations_upload.php?id=<?php echo $row[0]; ?>&ProImage=Del" class="btn btn-lighten-danger" onClick="return confirm('Are you sure want to delete?');">Delete</a>
                                            <? } ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="file" id="affiliations_file" name="affiliations_file" class="dropify" data-default-file="<? if($row[6]!=''){echo "../affiliations_pdf/".$row[6];}?>" />
                                            <? if($row[6]!=''){?>
                                                <a href="affiliations_upload.php?id=<?php echo $row[0]; ?>&PDF=Del" class="btn btn-lighten-danger" onClick="return confirm('Are you sure want to delete?');">Delete</a>
                                            <? } ?>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-12">
                                            ...
                                            <button type="submit" name="myButton" id="myButton" class="btn btn-lighten-danger" onClick="window.location.href='affiliationsView.php'; return false;" >Cancel</button>
                                        </div>
                                    </div>
