  ...
  <div class="main-content bg-lighter">
    ...
    <section style="padding-bottom:20px;">
      <div class="container pb-0">
        <div class="row text-center" id="missionSec">
          <?
          $sqlAboutInsExtra = $cn->selectdb("select page_name, image, page_desc from tbl_page where page_parent_id = $page_id");
          if( $cn->numRows($sqlAboutInsExtra) > 0 )
          {
            while($rowAboutInsExtra = $cn->fetchAssoc($sqlAboutInsExtra))
            {
              extract($rowAboutInsExtra);
          ?>
          <div class="col-sm-4 Mcol" >
            <div class="icon-box iconbox-border iconbox-theme-colored p-40" style="height:340px;">
              <a href="javascript:void(0)" class="icon icon-gray icon-bordered icon-border-effect effect-flat">
                <img src="page/big_img/<?echo $image?>"/>
              </a>
              <h5 class="icon-box-title"><?echo $page_name ?></h5>
              <p class="text-gray"><?echo strip_tags($page_desc) ?></p>
