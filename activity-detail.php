        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12 text-center">
              <h3 class="font-28 text-white"><?echo $event_title ?></h2>
              <ol class="breadcrumb text-center text-black mt-10">
                <li><a href="#">Home</a></li>
                <li><a href="activities">Activities</a></li>
                <li class="active text-gray-silver"><?echo $event_title ?></li>
              </ol>
            </div>
          </div>
        </div>
              ...
              ?>
                <div class="item">
                  <a  data-rel="prettyPhoto" href="eventF/big_img/<? echo $imgs[$i];?>">
                    <img src="eventF/big_img/<? echo $imgs[$i];?>" alt="<?echo $event_title?>" class="gallery-slider-img">
                  </a>
                </div>
